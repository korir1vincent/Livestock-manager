// src/screens/VetScreen.js
import React, { useState, useEffect } from 'react';
import { View, StyleSheet, ScrollView, RefreshControl, TouchableOpacity } from 'react-native';
import { Card, Title, Text, Button, ActivityIndicator, Chip, Avatar } from 'react-native-paper';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabBar}>
        ...
        >
          <Text style={[styles.tabText, activeTab === 'vets' && styles.activeTabText]}>
            Find Vets
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
              ...
              <Card.Content>
                <View style={styles.emergencyHeader}>
                  ...
                  <View style={styles.emergencyInfo}>
                    ...
                    <Text style={styles.emergencyText}>24/7 Emergency Veterinary Service</Text>
                  ...
                  <Card.Content>
                    <View style={styles.vetHeader}>
                      ...
                      <View style={styles.vetInfo}>
                        ...
                        <View style={styles.ratingRow}>
                          ...
                          <Text style={styles.reviews}>({vet.reviewCount} reviews)</Text>
                        </View>
                      </View>
                      <Chip
                        style={[
                    ...
                    <View style={styles.vetDetails}>
                      <View style={styles.detailRow}>
                        ...
                        <Text style={styles.detailText}>Avg response: 5 minutes</Text>
                      </View>
                      <View style={styles.detailRow}>
                        <Icon name="video" size={18} color="#6b7280" />
                        <Text style={styles.detailText}>Video or text consultation</Text>
                      </View>
                      <View style={styles.detailRow}>
                    ...
                    <Button
                      ...
                      icon="video"
                      onPress={() =>
                        navigation.navigate('BookConsultation', { vetId: vet._id })
                      }
