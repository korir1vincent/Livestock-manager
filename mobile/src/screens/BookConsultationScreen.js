        ...
        <View style={styles.content}>
          ...
          {vet && (
            <View style={styles.vetSummary}>
              ...
              <Text style={styles.vetFee}>
                Consultation Fee: KES{vet.consultationFee}
              </Text>
            </View>
          )}
              ...
              <View style={styles.animalRow}>
                ...
                {animals.map((animal) => (
                  <Button
                    ...
                    style={styles.animalChip}
                    buttonColor={
                      formData.animalId === animal._id ? "#16a34a" : undefined
                    }
                    compact
                  >
                    {animal.name}
