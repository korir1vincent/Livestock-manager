...
const RemindersScreen = ({ navigation }) => {
  ...
  const reminderTypes = ['All', 'Vaccination', 'Checkup', 'Medication', 'Breeding', 'Deworming', 'Other'];
  ...
  const upcomingReminders = filteredReminders.filter(r => !r.completed && !isOverdue(r.date));
  const overdueReminders = filteredReminders.filter(r => !r.completed && isOverdue(r.date));
