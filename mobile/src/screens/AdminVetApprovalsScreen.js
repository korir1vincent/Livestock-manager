// src/screens/AdminVetApprovalsScreen.js
import React, { useState, useEffect } from 'react';
import { View, StyleSheet, ScrollView, RefreshControl, Alert } from 'react-native';
import { Card, Title, Text, Button, ActivityIndicator, Chip, TextInput } from 'react-native-paper';
            ...
            <Card key={vet._id} style={styles.card}>
              <Card.Content>
                <View style={styles.cardHeader}>
                  ...
                  <Chip style={styles.pendingChip} textStyle={{ color: '#fff' }}>Pending</Chip>
                </View>
                ...
                <View style={styles.infoGrid}>
                  ...
                  <View style={styles.infoRow}>
                    ...
                    <Text style={styles.infoText}>License: {vet.licenseNumber}</Text>
                  </View>
                  <View style={styles.infoRow}>
                    <Icon name="briefcase" size={16} color="#6b7280" />
                    <Text style={styles.infoText}>{vet.experience} years experience</Text>
                  </View>
                  <View style={styles.infoRow}>
                    <Icon name="currency-usd" size={16} color="#6b7280" />
                    <Text style={styles.infoText}>Fee: ${vet.consultationFee}</Text>
                  </View>
                  <View style={styles.infoRow}>
                  ...
                  {vet.location?.city && (
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.infoText}>{vet.location.city}, {vet.location.country}</Text>
                    </View>
                  )}
                </View>
                ...
                {vet.languages?.length > 0 && (
                  <Text style={styles.languages}>Languages: {vet.languages.join(', ')}</Text>
                )}
...
const styles = StyleSheet.create({
  ...
  bioBox: { backgroundColor: '#f9fafb', padding: 10, borderRadius: 8, marginBottom: 10 },
  bioLabel: { fontSize: 12, fontWeight: '600', color: '#374151', marginBottom: 4 },
