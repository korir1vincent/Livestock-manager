            ...
            <Card style={styles.card}>
              <Card.Content style={styles.analyzingContent}>
                ...
                <Text style={styles.analyzingText}>
                  AI is analyzing your livestock...
                </Text>
            ...
            scanHistory.map((scan) => (
              <View key={scan._id}>
                <TouchableOpacity
                  onPress={() =>
                    setExpandedScanId(
                      expandedScanId === scan._id ? null : scan._id,
                    )
                  }
                >
                  <Card
                    style={[
                      styles.historyCard,
                      expandedScanId === scan._id && styles.historyCardActive,
                    ]}
                  >
                    <Card.Content>
                ...
                {expandedScanId === scan._id && renderFullResults(scan)}
              </View>
            ))
          )}
        </View>
