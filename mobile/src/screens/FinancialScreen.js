...
const FinancialScreen = ({ navigation }) => {
  ...
  const handleGenerateReport = async () => {
    Alert.alert(
      "Generate Report",
      "A PDF financial report will be generated and sent to your registered email.",
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            try {
              const api = getAuthenticatedAxios();
              const response = await api.post("/financial/report");
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
              ...
              <Card.Content>
                ...
                <View style={styles.transactionSummary}>
                  <View style={styles.summaryRow}>
                    ...
                    <Text style={styles.summaryLabel}>
                      {summary.transactionCount.expenses}
                    </Text>
                  </View>
                  <View style={styles.summaryRow}>
                    <Text style={styles.summaryLabel}>
                    ...
                    <Text style={styles.summaryLabel}>
                      {summary.transactionCount.revenues}
                    </Text>
                  </View>
                </View>
              </Card.Content>
                ...
                <Card key={expense._id} style={styles.transactionCard}>
                  <Card.Content>
                    <View style={styles.transactionHeader}>
                      ...
                      <Text
                        style={[styles.transactionAmount, styles.expenseAmount]}
                      >
                ...
                <Card key={revenue._id} style={styles.transactionCard}>
                  <Card.Content>
                    <View style={styles.transactionHeader}>
                      ...
                      >
                        <Icon
                          name={getCategoryIcon(revenue.category)}
                          size={24}
                      ...
                      <Text
                        style={[styles.transactionAmount, styles.revenueAmount]}
                      >
      ...
      <SafeAreaView>
        <FAB
          ...
          label={generatingReport ? "Sending..." : "Report"}
          color="#fff"
